...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/aripTaz/permission/main/ipmini > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/aripTaz/permission/main/ipmini | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/ariptaz/permission/main/ipmini | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/aripTaz/permission/main/ipmini | grep $MYIP | awk '{print $3}')
fi
...
echo -e "║${white}[•2]${NC} ║ ${kuning}vmess${NC}       "  
echo -e "║${white}[•3]${NC} ║ ${kuning}vless${NC}       "
echo -e "║${white}[•4]${NC} ║ ${kuning}trojan-go${NC}   "
echo -e "║${white}[•5]${NC} ║ ${kuning}trojan-ws${NC}   "
echo -e "║${white}[•6]${NC} ║ ${kuning}Check Running${NC}"
echo -e "║${white}[•7]${NC} ║ ${kuning}Restart Service${NC}"
echo -e "║${white}[•8]${NC} ║ ${kuning}Menu Backup${NC} "
echo -e "║${white}[•9]${NC} ║ ${kuning}Set Pw Vps${NC}  "
echo -e "║${white}[•10]${NC}║ ${kuning}Set Reboot${NC}  "
echo -e "║${white}[•11]${NC}║ ${kuning}Check Running${NC}"
echo -e "${white}╠════════════════════════════════════════════╣${NC}"    
